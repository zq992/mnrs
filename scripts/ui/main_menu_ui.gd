...
func _ready() -> void:
	...
	# 西周主题样式
	VisualConfig.style_title_label(title_label, 48)
	VisualConfig.style_heading_label(subtitle_label, 22)
	VisualConfig.style_small_label(version_label, 12)
	VisualConfig.style_button(start_button, 18)
